...
export class ChartTitle implements ChartComponent {
  ...
  public constructor(
    ...
    private chartConfig: RadarChartConfig,
    private chartData: RadarChartData,
    private chartThemeConfig: RadarChartThemeConfig
  ) {
    this.boundingRect = {
      x: 0,
      y: 0,
  ...
  public setBoundingBoxXY(point: Point): void {
    this.boundingRect.x = point.x;
    this.boundingRect.y = point.y;
  }

  public calculateSpace(availableSpace: Dimension): Dimension {
  ...
  public getDrawableElements(): DrawableElem[] {
