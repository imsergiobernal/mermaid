export interface RadarChartAxisThemeConfig {
  titleColor: string;
  labelColor: string;
  tickColor: string;
...
export interface RadarChartThemeConfig {
 ...
 */
export interface RadarChartAxisConfig {
  showLabel: boolean;
...
export interface RadarChartConfig {
  ...
  titlePadding: number;
  showTitle: boolean;
  xAxis: RadarChartAxisConfig;
  yAxis: RadarChartAxisConfig;
